...
\param position a const sf::Vector2f& - The position of the gem
*/
Gem::Gem(b2World* world, const sf::Vector2f & position)
	: PhysicsObject(world)
{
	...
	rec->setTexture(ResourceManager::getInstance()->getTexture("gem"));
	m_drawable = rec;
}
...
*/
bool Gem::contains(sf::Vector2f pos)
{
	return false;
}
...
*/
void Gem::enterCollision(const PhysicsObject* collider, const bool fixtureASensor, const bool fixtureBSensor)
{
